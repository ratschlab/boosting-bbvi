...
flags = tf.app.flags
FLAGS = flags.FLAGS
flags.DEFINE_float('relbo_reg', 1., 'regularization parameter for relbo opt')
flags.DEFINE_string('relbo_anneal', '1oversqrt', 'choose from [constant, linear, log, 1oversqrt]')
flags.DEFINE_boolean('use_rb', False, '')
...
class KLqp(VariationalInference):
  ...
  """
  def __init__(self, latent_vars=None, fw_iterates={}, fw_iter=None, data=None):
...
def build_score_rb_loss_and_gradients_relbo(inference, var_list):
  """Build loss function and gradients based on the score function
  estimator [@paisley2012variational] and Rao-Blackwellization
  [@ranganath2014black].
